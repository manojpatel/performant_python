...
jinja_env.add_template("report.html", """
<!DOCTYPE html>
<html lang="en">
<head>
...
class SearchEngine:
    ...
    def seed(self, size: int = 10000):
        ...
        for i in range(size):
            ...
            body = f"This is the body of document {i}. It mentions Rust, Python, and Speed. The number is {i}."
            if i % 2 == 0:
    ...
    @lru_cache(maxsize=256)  # Cache up to 256 different search queries
